...
class Ui_MainWindow(object):
    def __init__(self):
        MainWindow.setWindowIcon(QtGui.QIcon('logo.png'))  # window icon
    ...
    def startup(self, MainWindow):  # first window that shows up
        ...
        MainWindow.resize(404, 484)
        MainWindow.setFixedSize(404, 484)
        ...
        self.question.setGeometry(QtCore.QRect(110, 90, 191, 81))
        font.setPointSize(16)
        self.question.setFont(font)
        self.question.setText("Play Tic Tac Toe Vs")
